...
INSERT INTO Movies (Title, Years, Rated, Genre, Actors, Released, Plot,VideoFile) VALUES
   ("Kung Fu Panda 3","2016","PG", "Animation", "Jack Black, Angelina Jolie, Dustin Hoffman, Jackie Chan", "29 Jan 2016", "Continuing his legendary adventures of awesomeness, Po must face two hugely epic, but different threats: one supernatural and the other a little closer to his home.",NULL);
